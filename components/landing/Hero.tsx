...
export function Hero() {
  ...
  return (
    <section
      id="beranda"
      className="relative min-h-screen gradient-hero overflow-hidden pt-24 pb-16"
    >
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:gap-12 lg:px-8 lg:pt-12">
        <div className="animate-fade-in-up mx-auto w-full max-w-xl space-y-6 text-center lg:mx-0 lg:max-w-none lg:text-left">
          ...
          <p className="mx-auto max-w-lg text-lg leading-relaxed text-[var(--muted)] lg:mx-0">
            {t("landing.hero.description")}
          </p>
          <div className="flex flex-wrap justify-center gap-4 lg:justify-start">
            <Link
              href="/login"
              className="group inline-flex items-center gap-2 rounded-full gradient-primary px-7 py-3.5 font-semibold text-white shadow-lg transition-all hover:scale-105 hover:shadow-xl"
            >
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4 sm:gap-6 lg:justify-start">
        ...
        <div
          className="relative mx-auto w-full max-w-lg animate-fade-in-up lg:max-w-none lg:pl-8"
          style={{ animationDelay: "0.2s" }}
        >
          <div className="relative mx-auto aspect-[4/3] w-full overflow-hidden rounded-3xl shadow-2xl ring-4 ring-white/50">
            <Image
          ...
          <div className="absolute -bottom-4 left-1/2 z-10 -translate-x-1/2 animate-float rounded-2xl glass-card p-4 text-center shadow-xl sm:left-8 sm:translate-x-0 lg:-left-8">
